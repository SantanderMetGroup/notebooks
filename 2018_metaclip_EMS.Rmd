...
plot(metadata.EOBS$graph)
metaclipR::graph2json(metadata.EOBS$graph, output.file = "/tmp/kk.json")
...
# load("data/rcp85_eqm_list.rda", verbose = TRUE) 
# load("data/ensemble_rcp85_eqm.rda", verbose = TRUE)
# for (i in 1:length(TXrcp85.eqm.list)) {
    # ens.rcp85.eqm$Data <- round(ens.rcp85.eqm$Data, 2)
# }
# save(ens.rcp85.eqm, file = "data/ensemble_rcp85_eqm.rda", compress = "xz")
```
