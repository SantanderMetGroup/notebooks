...
`metaclipR` is currently hosted in [METACLIP's Public GitHub repository](https://github.com/Predictia/metaclipR). Using package `devtools` is highly recommended to ease installation:
