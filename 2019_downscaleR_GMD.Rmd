...
The analyses is performed on the daily time-series at each grid-box, after nearest-neighbour remapping of the EC-EARTH grid onto the reference 2-degree regular grid used in VALUE.
...
that are internally accomplished using the corresponding function of package transformeR (subsetGrid and scaleGrid).
```{r, eval = TRUE}
