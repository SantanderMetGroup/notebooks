...
Finally, the maps of raw (Fig. \ref{fig:fig5a}) and bias corrected (Fig. \ref{fig:fig5}) SU index for the EC-EARTH driven, RCP8.5 scenario (period 2071-2100) are plotted resulting in Figures \ref{fig:fig5a} (Not shown in the manuscript) and \ref{fig:fig5} (Fig. 5 in the manuscript).
...
***
NOTE: Find more worked examples on the utilization of climate4R packages in their respective GitHub **wiki**-s at [https://github.com/SantanderMetGroup](https://github.com/SantanderMetGroup):
