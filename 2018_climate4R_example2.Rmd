...
Finally `temporalPlot` is used to generate Figure 7 (Fig. 7 in the manuscript). The nearest point to Zaragoza (Spain) is selected via arguments `latLim` and `lonLim`:
